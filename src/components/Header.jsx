...
export default function Header({ links }) {
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group px-1 py-1 transition-transform transform inline-block ${
                      isActive ? "text-amber-500 font-semibold" : "text-slate-700"
  ...
  <NavLink to="/social/linkedin" 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24">
      ...
      <path d="M7.5 10.5V18M7.5 7.5v.01M12 18V12.75c0-1.75 2.25-1.89 2.25 0V18M12 10.5h0"
        stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <button className="md:hidden p-2 rounded-lg hover:bg-slate-100 transition" aria-label="menu">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M3 6h18M3 12h18M3 18h18" /></svg>
            </button>
          </div>
        </div>
      </nav>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full px-6">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-emerald-700 tracking-wide drop-shadow-sm">ABOUT US</h1>
      </div>
