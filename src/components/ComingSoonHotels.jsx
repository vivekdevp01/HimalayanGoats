...
import { Bed, MapPin, Bell, ArrowLeft } from "lucide-react";
      ...
      >
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2.5rem] p-8 md:p-16 shadow-2xl">
          ...
          <p className="text-lg text-white/80 mb-10 leading-relaxed font-medium">
            We're handpicking the finest hotels and most vibrant hostels for your next adventure. 
            Stay tuned for stays that feel like home.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="flex items-center justify-center gap-2 px-8 py-4 bg-white/10 border border-white/20 text-white rounded-2xl font-bold hover:bg-white/20 transition-all backdrop-blur-md">
              <Bell size={18} />
              Notify Me
            </button>
          </div>
