...
export default function Packages() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Riverside Camping in Rishikesh | Luxury & Adventure Camps | Tripshalla
        </title>
        <meta
          name="description"
          content="Book the best riverside and forest camps in Rishikesh. Enjoy stargazing, bonfires, and comfortable stays near the Ganga with Tripshalla Camping."
        />
        <meta
          name="keywords"
          content="Rishikesh camping, riverside camps Ganga, luxury camping Rishikesh, adventure camps"
        />
      </Helmet>
